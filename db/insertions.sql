...
SELECT setval('item_id_seq', 6, true);
-- tags
INSERT INTO Tags (tag_id, name) OVERRIDING SYSTEM VALUE VALUES
...
(25, 'Costume'),
(26, 'Outdoors');
SELECT setval('tag_id_seq', 26, true);
...
SELECT setval('auction_id_seq', 4, true);
